...
$res = $conn->query("SELECT total_books, total_categories, total_members, pending_requests, total_non_returned_books, total_issued_books FROM count_items LIMIT 1");
$row = $res->fetch_assoc();
echo json_encode([
